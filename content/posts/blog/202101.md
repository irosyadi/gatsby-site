...
* [PY4E - Python for Everybody](https://www.py4e.com/) License: CC-NC, you do not need my permission to translate, produce, and distributed electronic copies of the book. [You do need permission to sell printed copies of the translated book](https://github.com/csev/py4e/blob/master/TRANSLATION.md).
